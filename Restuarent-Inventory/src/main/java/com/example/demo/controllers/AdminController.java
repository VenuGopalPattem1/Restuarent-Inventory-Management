...
public class AdminController {
	...
	public String userLogin( @ModelAttribute("userLogin") UserLogin login,Model model)
	{
		...
		if(uservices.validateLoginCredentials(email, password))
		{
			user = this.uservices.getUserByEmail(email);
	...
	{
		List<User> users= this.uservices.getAllUser();
	...
	{
		User user = this.uservices.getUser(id);
